...
One consequence of this perspective is that it sidesteps the question of what grammar generates the language: a lexicon and a distance function are sufficient to define the region, without any independent specification of phonotactic constraints. @bailey2001determinants and @vitevitch1999probabilistic showed that the probabilistic and similarity-based perspectives appear to make at least partially independent contributions to acceptability judgments, and we'll be able to test this directly at the end of the module, using the same @daland_explaining_2011 data we used in the [previous module](../uncertainty-about-languages/ngram-models.qmd).
