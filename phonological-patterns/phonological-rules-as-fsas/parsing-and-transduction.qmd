...
While FSTs are traditionally associated with rule-based phonology, they can also be used to implement constraint-based approaches like Optimality Theory (OT) [@prince1993optimality]. This is typically done by:
...
This approach has been successfully used to implement OT analyses of various phonological phenomena [@karttunen1998finite].
