...
class TransitionFunction:
    """Placeholder for transition function used in intersection."""
...
class FiniteStateAutomaton:
    ...
    def direct_intersection(self, other: 'FiniteStateAutomaton') -> 'FiniteStateAutomaton':
        ...
        # Construct the product automaton via reachability
        ...
        while stack:
            ...
            for symbol in new_alphabet:
                next_states1 = fsa1._transition_function(current_state[0], symbol)
                next_states2 = fsa2._transition_function(current_state[1], symbol)
                ...
                for q1 in next_states1:
                    for q2 in next_states2:
                        ...
                        if key in new_transition_graph:
                            new_transition_graph[key].add(next_state)
                        else:
                            new_transition_graph[key] = {next_state}
