...
def word_to_bio(word: str, morphemes: list[str]) -> list[str]:
    """Convert a word and its morphemes to BIO tags.

    Parameters
    ----------
    word : str
        The surface form (unused but kept for interface consistency).
    morphemes : list[str]
        The morpheme segments.

    Returns
    -------
    list[str]
        A BIO tag for each character.
    """
    tags = []
...
def chars_to_features(word: str) -> list[int]:
    ...
    -------
    list[int]
        Integer feature for each alphabetic character.
    """
...
def char_features(word: str, i: int) -> dict[str, str | bool]:
...
def word_to_features(word: str) -> list[dict[str, str | bool]]:
    """Extract character-level features for every position in a word.
    ...
    list[dict[str, str | bool]]
        One feature dictionary per character position.
    """
