...
In the previous section, we explored the CKY algorithm, a bottom-up parsing approach for context-free grammars. Now, we'll examine the [Earley algorithm](https://en.wikipedia.org/wiki/Earley_parser) [@earley_efficient_1970], which is a top-down parsing method that combines the advantages of both top-down and bottom-up approaches.
