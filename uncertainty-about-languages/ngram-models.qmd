...
The fact that a simple bigram or trigram model trained on a dictionary can predict a reasonable amount of variance in human acceptability judgments is striking. It suggests that a good deal of phonotactic knowledge can be captured by tracking short-range sequential regularities in the lexicon—consistent with the lexicalist approach that @daland_explaining_2011 investigate.
