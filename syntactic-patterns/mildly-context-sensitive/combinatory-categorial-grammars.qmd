...
class Category:
    ...
    def parse(s: str) -> 'Category':
        """Parse a category string into a Category object.

        Parameters
        ----------
        s : str
            A category string like ``'(S\\NP)/NP'``.
...
def forward_application(left: Category, right: Category) -> Category | None:
    """Apply forward application: X/Y + Y => X.
    ...
    -------
    Category | None
        The result category, or None if the rule does not apply.
    """
...
def backward_application(left: Category, right: Category) -> Category | None:
    """Apply backward application: Y + X\\Y => X.
...
def forward_composition(left: Category, right: Category) -> Category | None:
    """Apply forward composition: X/Y + Y/Z => X/Z.

    Parameters
    ----------
    left : Category
        The left functor category.
    right : Category
        The right functor category.

    Returns
    -------
    Category | None
        The composed category, or None if the rule does not apply.
    """
...
def backward_composition(left: Category, right: Category) -> Category | None:
    """Apply backward composition: Y\\Z + X\\Y => X\\Z.
...
class CCGParser:
    ...
    lexicon : dict[str, list[Category]]
        A mapping from words to their possible categories.
    """
    ...
    def parse(self, words: list[str], goal: Category = None) -> list:
        """Parse a list of words and return spanning categories.

        Parameters
        ----------
        words : list[str]
            The input words to parse.
        goal : Category, optional
            The target category (default ``AtomicCategory('S')``).

        Returns
        -------
        list
            A pair of matching categories and the chart.
        """
        if goal is None:
