...
MCFGs are equivalent to Linear Context-Free Rewriting Systems (LCFRS), introduced independently by @vijayshanker1987characterizing. The two formalisms differ in presentation but generate the same class of languages. I'll use the MCFG notation here, since it's what the [final project](../../assignments/final-project.ipynb) uses, but I'll point out the connection to LCFRS as presented by @kallmeyer_linear_2013, whose inference rules you'll implement in the final project.
