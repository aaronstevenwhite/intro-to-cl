...
This is the algorithm you will implement in the [final project](../assignments/final-project.ipynb). The beauty of the approach is that the same agenda-based algorithm works for CKY, Earley, TAG parsing, and MCFG parsing—the only thing that changes is the set of items and inference rules. For MCFG parsing, you'll use the inference rules from @kallmeyer_linear_2013, which generalize the CKY rules above to handle the multi-component yields that MCFGs allow.
